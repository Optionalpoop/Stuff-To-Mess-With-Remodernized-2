...
public class TrumpEntity extends Monster {
	...
	public TrumpEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.TRUMP.get(), world);
	}

	public TrumpEntity(EntityType<TrumpEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(3f);
		xpReward = 150;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.HILT_OF_LABUBU.get()));
	}
