...
public class TheTimelessEntity extends Monster {
	...
	public TheTimelessEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.THE_TIMELESS.get(), world);
	}

	public TheTimelessEntity(EntityType<TheTimelessEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(10f);
		xpReward = 500;
		setNoAi(false);
