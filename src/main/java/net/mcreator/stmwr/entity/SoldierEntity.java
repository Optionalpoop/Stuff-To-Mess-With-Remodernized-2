...
public class SoldierEntity extends PathfinderMob implements RangedAttackMob {
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		HandgunRoundAmmoEntity.shoot(this, target);
	}

	public static void init() {
		SpawnPlacements.register(StmwrModEntities.SOLDIER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
