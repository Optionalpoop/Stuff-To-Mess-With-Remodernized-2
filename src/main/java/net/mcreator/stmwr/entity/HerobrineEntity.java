...
import net.mcreator.stmwr.procedures.HerobrineOnInitialEntitySpawnProcedure;
import net.mcreator.stmwr.procedures.HerobrineOnEntityTickUpdateProcedure;
import net.mcreator.stmwr.procedures.HerobrineEntityIsHurtProcedure;
...
public class HerobrineEntity extends Monster {
	...
	public HerobrineEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StmwrModEntities.HEROBRINE.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StmwrModItems.HEROBRINES_SOUL.get()));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		HerobrineOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
