...
public abstract class CobblestoneArmorItem extends ArmorItem {
	public CobblestoneArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends CobblestoneArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "stmwr:textures/models/armor/cobblestone_layer_1.png";
		}
	}
	...
	public static class Leggings extends CobblestoneArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "stmwr:textures/models/armor/cobblestone_layer_2.png";
		}
	}
