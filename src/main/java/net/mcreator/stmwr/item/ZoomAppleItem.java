...
import net.mcreator.stmwr.procedures.ZoomApplePlayerFinishesUsingItemProcedure;
import net.mcreator.stmwr.init.StmwrModItems;

public class ZoomAppleItem extends Item {
	public ZoomAppleItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		ZoomApplePlayerFinishesUsingItemProcedure.execute(entity);
