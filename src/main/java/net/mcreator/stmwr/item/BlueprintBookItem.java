...
import net.mcreator.stmwr.item.inventory.BlueprintBookInventoryCapability;
...
public class BlueprintBookItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Blueprint Book");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new BlueprintBookHomePageMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
		...
		ToBlueprintBookHomePageProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new BlueprintBookInventoryCapability();
	}
