...
public class LightningCultistEntityIsHurtProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, DamageSource damagesource, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) > (entity instanceof LivingEntity _livEnt ? _livEnt.getMaxHealth() : -1) / 3) {
			if (damagesource.is(DamageTypes.LIGHTNING_BOLT) == false && damagesource.is(DamageTypes.IN_FIRE) == false && damagesource.is(DamageTypes.ON_FIRE) == false) {
