...
public class SoulManipulatorMultiblockProcedureProcedure {
			...
			if ((world.getBlockState(BlockPos.containing(x + 0, y + -1, z + 0))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
				if ((world.getBlockState(BlockPos.containing(x + 1, y + -1, z + 0))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
					if ((world.getBlockState(BlockPos.containing(x + 0, y + -1, z + -1))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
						if ((world.getBlockState(BlockPos.containing(x + 1, y + -1, z + -1))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
							if ((world.getBlockState(BlockPos.containing(x + 1, y + 0, z + 0))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
								if ((world.getBlockState(BlockPos.containing(x + 0, y + 0, z + -1))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
									if ((world.getBlockState(BlockPos.containing(x + 1, y + 0, z + -1))).getBlock() == StmwrModBlocks.MAGICAL_CASING.get()) {
										if (entity instanceof ServerPlayer _ent) {
											BlockPos _bpos = BlockPos.containing(x, y, z);
											NetworkHooks.openScreen((ServerPlayer) _ent, new MenuProvider() {
												@Override
												public Component getDisplayName() {
													return Component.literal("SoulManipulatorGUI");
												}

												@Override
												public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
													return new SoulManipulatorGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
												}
											}, _bpos);
										}
									} else {
