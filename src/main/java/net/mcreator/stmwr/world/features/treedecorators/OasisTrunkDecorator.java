...
public class OasisTrunkDecorator extends TrunkVineDecorator {
	public static Codec<OasisTrunkDecorator> CODEC = Codec.unit(OasisTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("oasis_tree_trunk_decorator", DECORATOR_TYPE));
	}
