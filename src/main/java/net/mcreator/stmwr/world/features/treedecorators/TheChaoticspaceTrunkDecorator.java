...
public class TheChaoticspaceTrunkDecorator extends TrunkVineDecorator {
	public static Codec<TheChaoticspaceTrunkDecorator> CODEC = Codec.unit(TheChaoticspaceTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_chaoticspace_tree_trunk_decorator", DECORATOR_TYPE));
	}
