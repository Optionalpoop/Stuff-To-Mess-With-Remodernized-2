...
public class TheWishingspaceFruitDecorator extends CocoaDecorator {
	public static Codec<TheWishingspaceFruitDecorator> CODEC = Codec.unit(TheWishingspaceFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_wishingspace_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public TheWishingspaceFruitDecorator() {
		super(0.2f);
	}
