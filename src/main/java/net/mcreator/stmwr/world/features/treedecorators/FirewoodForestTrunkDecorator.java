...
public class FirewoodForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<FirewoodForestTrunkDecorator> CODEC = Codec.unit(FirewoodForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("firewood_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
