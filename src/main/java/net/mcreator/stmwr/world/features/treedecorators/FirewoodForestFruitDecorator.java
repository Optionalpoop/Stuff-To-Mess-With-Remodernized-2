...
public class FirewoodForestFruitDecorator extends CocoaDecorator {
	public static Codec<FirewoodForestFruitDecorator> CODEC = Codec.unit(FirewoodForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("firewood_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public FirewoodForestFruitDecorator() {
		super(0.2f);
	}
