...
public class TheLovespaceTrunkDecorator extends TrunkVineDecorator {
	public static Codec<TheLovespaceTrunkDecorator> CODEC = Codec.unit(TheLovespaceTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_lovespace_tree_trunk_decorator", DECORATOR_TYPE));
	}
