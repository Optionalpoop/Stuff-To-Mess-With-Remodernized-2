...
public class FrozenForestFruitDecorator extends CocoaDecorator {
	public static Codec<FrozenForestFruitDecorator> CODEC = Codec.unit(FrozenForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("frozen_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public FrozenForestFruitDecorator() {
		super(0.2f);
	}
