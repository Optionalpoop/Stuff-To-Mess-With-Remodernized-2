...
public class FrozenForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<FrozenForestTrunkDecorator> CODEC = Codec.unit(FrozenForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("frozen_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
