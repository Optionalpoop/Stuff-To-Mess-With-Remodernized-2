...
public class TheWishingspaceTrunkDecorator extends TrunkVineDecorator {
	public static Codec<TheWishingspaceTrunkDecorator> CODEC = Codec.unit(TheWishingspaceTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_wishingspace_tree_trunk_decorator", DECORATOR_TYPE));
	}
