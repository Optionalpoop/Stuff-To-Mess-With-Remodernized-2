...
public class TheChaoticspaceFruitDecorator extends CocoaDecorator {
	public static Codec<TheChaoticspaceFruitDecorator> CODEC = Codec.unit(TheChaoticspaceFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_chaoticspace_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public TheChaoticspaceFruitDecorator() {
		super(0.2f);
	}
