...
public class TheLovespaceFruitDecorator extends CocoaDecorator {
	public static Codec<TheLovespaceFruitDecorator> CODEC = Codec.unit(TheLovespaceFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_lovespace_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public TheLovespaceFruitDecorator() {
		super(0.2f);
	}
