...
public class SoulManipulatorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SoulManipulatorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StmwrModMenus.SOUL_MANIPULATOR_GUI.get(), id);
