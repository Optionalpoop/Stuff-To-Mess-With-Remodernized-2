...
public class ExtremePocketCellGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ExtremePocketCellGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StmwrModMenus.EXTREME_POCKET_CELL_GUI.get(), id);
