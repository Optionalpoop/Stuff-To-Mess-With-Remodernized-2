...
public class DoomforgeGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DoomforgeGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StmwrModMenus.DOOMFORGE_GUI.get(), id);
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 79, 80) {
			private final int slot = 6;
		}));
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 61, 80) {
			private final int slot = 7;
		}));
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 43, 80) {
		...
		this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 25, 26) {
			private final int slot = 11;
		}));
		this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 7, 90) {
			private final int slot = 12;
		}));
		this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 61, 44) {
			private final int slot = 13;
		}));
		this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 151, 27) {
		...
		this.customSlots.put(15, this.addSlot(new SlotItemHandler(internal, 15, 6, 6) {
