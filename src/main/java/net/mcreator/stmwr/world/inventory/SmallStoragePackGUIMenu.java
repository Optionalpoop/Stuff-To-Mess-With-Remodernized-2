...
public class SmallStoragePackGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SmallStoragePackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
