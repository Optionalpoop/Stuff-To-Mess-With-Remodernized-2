...
import net.mcreator.stmwr.client.renderer.TrumpRenderer;
...
import net.mcreator.stmwr.client.renderer.ShadowManRenderer;
import net.mcreator.stmwr.client.renderer.SatanRenderer;
...
import net.mcreator.stmwr.client.renderer.PeacefulChillGuyRenderer;
import net.mcreator.stmwr.client.renderer.PaperBoyRenderer;
import net.mcreator.stmwr.client.renderer.MinionOfFireRenderer;
import net.mcreator.stmwr.client.renderer.LoveMiteRenderer;
...
import net.mcreator.stmwr.client.renderer.InfinititeGolemRenderer;
...
import net.mcreator.stmwr.client.renderer.HugEnjoyerRenderer;
import net.mcreator.stmwr.client.renderer.HordebeastRenderer;
import net.mcreator.stmwr.client.renderer.HerobrineRenderer;
import net.mcreator.stmwr.client.renderer.HappyPigRenderer;
import net.mcreator.stmwr.client.renderer.HappyCowRenderer;
import net.mcreator.stmwr.client.renderer.HappyChickenRenderer;
...
import net.mcreator.stmwr.client.renderer.GhostRenderer;
import net.mcreator.stmwr.client.renderer.FrombieRenderer;
import net.mcreator.stmwr.client.renderer.ForceOfFireRenderer;
import net.mcreator.stmwr.client.renderer.ForceOfEmotionRenderer;
import net.mcreator.stmwr.client.renderer.ForceOfDreamsRenderer;
import net.mcreator.stmwr.client.renderer.ForceOfChaosRenderer;
import net.mcreator.stmwr.client.renderer.FireSlingerRenderer;
import net.mcreator.stmwr.client.renderer.FireGuardianRenderer;
...
public class StmwrModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(StmwrModEntities.SHADOW_MAN.get(), ShadowManRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.HAPPY_PIG.get(), HappyPigRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.HAPPY_CHICKEN.get(), HappyChickenRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.HAPPY_COW.get(), HappyCowRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.PEACEFUL_CHILL_GUY.get(), PeacefulChillGuyRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.LOVE_PELLET_AMMO.get(), ThrownItemRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.HUG_ENJOYER.get(), HugEnjoyerRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.GHOST.get(), GhostRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.LOVE_MITE.get(), LoveMiteRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.MINION_OF_FIRE.get(), MinionOfFireRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.FIRE_GUARDIAN.get(), FireGuardianRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.FORCE_OF_EMOTION.get(), ForceOfEmotionRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.FORCE_OF_CHAOS.get(), ForceOfChaosRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.FORCE_OF_DREAMS.get(), ForceOfDreamsRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.FORCE_OF_FIRE.get(), ForceOfFireRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.SATAN.get(), SatanRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.TRUMP.get(), TrumpRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.INFINITITE_GOLEM.get(), InfinititeGolemRenderer::new);
		event.registerEntityRenderer(StmwrModEntities.HEROBRINE.get(), HerobrineRenderer::new);
	}
}
