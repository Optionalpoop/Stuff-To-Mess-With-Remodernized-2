...
public class StmwrModTabs {
	...
	public static final RegistryObject<CreativeModeTab> STMWR_MILITARIA = REGISTRY.register("stmwr_militaria",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmwr_militaria")).icon(() -> new ItemStack(StmwrModItems.URANIUM_DUST.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(StmwrModItems.STORUM_SPRING.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> STMWR_WIZARD_WORLD = REGISTRY.register("stmwr_wizard_world",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stmwr_wizard_world")).icon(() -> new ItemStack(StmwrModItems.SKIN.get())).displayItems((parameters, tabData) -> {
				tabData.accept(StmwrModItems.WIZARD_WORLD.get());
				tabData.accept(StmwrModItems.MAGICAL_TRIAL_HEART.get());
				tabData.accept(StmwrModBlocks.FIREGRASS.get().asItem());
				tabData.accept(StmwrModBlocks.FIREDIRT.get().asItem());
				tabData.accept(StmwrModBlocks.FIRESTONE.get().asItem());
				tabData.accept(StmwrModBlocks.COBBLED_FIRESTONE.get().asItem());
				tabData.accept(StmwrModBlocks.SMOOTH_FIRESTONE.get().asItem());
				tabData.accept(StmwrModBlocks.SMOOTH_FIRESTONE_SLAB.get().asItem());
				tabData.accept(StmwrModBlocks.BRIMSTONE.get().asItem());
				tabData.accept(StmwrModBlocks.HEATED_SAPPHIRE.get().asItem());
				tabData.accept(StmwrModItems.SAPPHIRE.get());
				tabData.accept(StmwrModBlocks.FIRE_GOLD.get().asItem());
				tabData.accept(StmwrModBlocks.FIRE_IRON.get().asItem());
				tabData.accept(StmwrModBlocks.QUIET_GRASS.get().asItem());
				tabData.accept(StmwrModBlocks.NOSTALGIADIRT.get().asItem());
				tabData.accept(StmwrModBlocks.MEMORYSTONE.get().asItem());
				tabData.accept(StmwrModBlocks.CRUSHED_MEMORYSTONE.get().asItem());
				tabData.accept(StmwrModBlocks.SMOOTH_MEMORYSTONE.get().asItem());
				tabData.accept(StmwrModBlocks.SMOOTH_MEMORYSTONE_SLAB.get().asItem());
				tabData.accept(StmwrModBlocks.FORGOTTEN_SAND.get().asItem());
				tabData.accept(StmwrModBlocks.FORGOTTEN_GLASS.get().asItem());
				tabData.accept(StmwrModBlocks.DREAMY_MAGICITE_ORE.get().asItem());
				tabData.accept(StmwrModBlocks.DREAMSTONE_ORE.get().asItem());
				tabData.accept(StmwrModBlocks.DREAMSTONE_BLOCK.get().asItem());
				tabData.accept(StmwrModItems.DREAMSTONE.get());
				tabData.accept(StmwrModBlocks.GRACEFUL_GRASS.get().asItem());
				tabData.accept(StmwrModBlocks.DELICIOUS_DIRT.get().asItem());
				tabData.accept(StmwrModBlocks.SUPER_STONE.get().asItem());
				tabData.accept(StmwrModBlocks.PINKSTONE.get().asItem());
				tabData.accept(StmwrModBlocks.DELICATELY_PAVED_PINKSTONE.get().asItem());
				tabData.accept(StmwrModBlocks.DELICATELY_PAVED_PINKSTONE_SLAB.get().asItem());
				tabData.accept(StmwrModBlocks.HEART_CRYSTAL.get().asItem());
				tabData.accept(StmwrModItems.HEART_CRYSTAL_SHARD.get());
				tabData.accept(StmwrModBlocks.STUFFED_STORUM_ORE.get().asItem());
				tabData.accept(StmwrModBlocks.BIG_REDSTONE_ORE.get().asItem());
				tabData.accept(StmwrModBlocks.SP_EC_IA_LG_RA_SS.get().asItem());
				tabData.accept(StmwrModBlocks.SP_EC_IA_LC_RU_NC_HE_DD_IR_T.get().asItem());
				tabData.accept(StmwrModBlocks.SP_EC_IA_LS_TO_NE.get().asItem());
				tabData.accept(StmwrModBlocks.SP_EC_IA_LC_OB_BL_ED_ST_ON_E.get().asItem());
				tabData.accept(StmwrModBlocks.SP_EC_IA_LS_MO_OT_HS_TO_NE.get().asItem());
				tabData.accept(StmwrModBlocks.SP_EC_IA_LS_MO_OT_HS_TO_NE_SL_AB.get().asItem());
				tabData.accept(StmwrModBlocks.CHAOTIC_ORE.get().asItem());
				tabData.accept(StmwrModItems.CHAOS_ORB.get());
				tabData.accept(StmwrModBlocks.WISHING_TREE_LEAVES.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_WOOD.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_LOG.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_PLANKS.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_STAIRS.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_SLAB.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_PRESSURE_PLATE.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_BUTTON.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_FENCE.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_TREE_FENCE_GATE.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_LEAVES.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_WOOD.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_LOG.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_PLANKS.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_STAIRS.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_SLAB.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_PRESSURE_PLATE.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_BUTTON.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_FENCE.get().asItem());
				tabData.accept(StmwrModBlocks.CANDY_FENCE_GATE.get().asItem());
				tabData.accept(StmwrModItems.INFINITITE_INGOT.get());
				tabData.accept(StmwrModBlocks.BURNING_GRASS.get().asItem());
				tabData.accept(StmwrModBlocks.WISHFUL_GRASS.get().asItem());
				tabData.accept(StmwrModBlocks.DARK_GRASS.get().asItem());
				tabData.accept(StmwrModBlocks.SOFT_GRASS.get().asItem());
				tabData.accept(StmwrModBlocks.SINGEWORM.get().asItem());
				tabData.accept(StmwrModBlocks.BURNFLOWER.get().asItem());
				tabData.accept(StmwrModBlocks.FIREBLOSSOM.get().asItem());
				tabData.accept(StmwrModBlocks.SILENTA.get().asItem());
				tabData.accept(StmwrModBlocks.WISHING_STAR.get().asItem());
				tabData.accept(StmwrModBlocks.HIPPOPOTOMONSTROSESQUIPPEDALIOPHOBIA.get().asItem());
				tabData.accept(StmwrModBlocks.CHARGOGGAGOGMANCHAUGGAGOGCHAUBUNAGUNGAMAUG.get().asItem());
				tabData.accept(StmwrModBlocks.RAXACORICOFALAPATORIOUS.get().asItem());
				tabData.accept(StmwrModBlocks.SCREAMER.get().asItem());
				tabData.accept(StmwrModBlocks.JOYFUL_GAZE.get().asItem());
				tabData.accept(StmwrModBlocks.HEARTLY.get().asItem());
				tabData.accept(StmwrModBlocks.GATEWAY_BRICK.get().asItem());
				tabData.accept(StmwrModBlocks.EYEFORGE.get().asItem());
				tabData.accept(StmwrModBlocks.INFINITY_FORGE.get().asItem());
				tabData.accept(StmwrModItems.GOBLIN_CACHE.get());
				tabData.accept(StmwrModItems.SKIN.get());
				tabData.accept(StmwrModItems.EYE.get());
				tabData.accept(StmwrModItems.BRAIN.get());
				tabData.accept(StmwrModItems.LUNG.get());
				tabData.accept(StmwrModItems.HEART.get());
				tabData.accept(StmwrModItems.YUMMY_PORK.get());
				tabData.accept(StmwrModItems.YUMMY_BEEF.get());
				tabData.accept(StmwrModItems.SOFT_LEATHER.get());
				tabData.accept(StmwrModItems.YUMMY_CHICKEN.get());
				tabData.accept(StmwrModItems.FEATHER_OF_JOY.get());
				tabData.accept(StmwrModItems.LOVE_EGG.get());
				tabData.accept(StmwrModItems.STOMACH.get());
				tabData.accept(StmwrModItems.FIREBLOOD.get());
				tabData.accept(StmwrModItems.WEASEL_FUR.get());
				tabData.accept(StmwrModItems.HEATED_FLESH.get());
				tabData.accept(StmwrModItems.MYSTICAL_PAPER.get());
				tabData.accept(StmwrModItems.MEAT.get());
				tabData.accept(StmwrModItems.TUSK.get());
				tabData.accept(StmwrModItems.CIGAR_BASE.get());
				tabData.accept(StmwrModItems.CIGARETTE.get());
				tabData.accept(StmwrModItems.LOVE_PELLET.get());
				tabData.accept(StmwrModItems.HEAL_HEART.get());
				tabData.accept(StmwrModItems.LAVA_CHICKEN.get());
				tabData.accept(StmwrModItems.SHARD_OF_PAIN.get());
				tabData.accept(StmwrModItems.ORB_OF_HORROR.get());
				tabData.accept(StmwrModItems.MAGIC_POWDER.get());
				tabData.accept(StmwrModItems.WIZARDS_EYE.get());
				tabData.accept(StmwrModItems.LABUBU_BOX.get());
				tabData.accept(StmwrModItems.BASIC_LABUBU.get());
				tabData.accept(StmwrModItems.FLAME_LABUBU.get());
				tabData.accept(StmwrModItems.BANANA_LABUBU.get());
				tabData.accept(StmwrModItems.GRAY_RAINBOW_LABUBU.get());
				tabData.accept(StmwrModItems.SOUL_OF_FLAME.get());
				tabData.accept(StmwrModItems.SOUL_OF_WISHES.get());
				tabData.accept(StmwrModItems.SOUL_OF_ENTROPY.get());
				tabData.accept(StmwrModItems.SOUL_OF_LIGHT.get());
				tabData.accept(StmwrModItems.HEROBRINES_SOUL.get());
				tabData.accept(StmwrModItems.THE_ENDREALM.get());
				tabData.accept(StmwrModItems.INFINITITE_SCRAP.get());
				tabData.accept(StmwrModItems.PARALLEL_UNIVERSE.get());
				tabData.accept(StmwrModItems.GREATER_CREATION_ORB.get());
				tabData.accept(StmwrModItems.HILT_OF_LABUBU.get());
				tabData.accept(StmwrModItems.BLADE_OF_LABUBU.get());
				tabData.accept(StmwrModItems.SWORD_OF_LABUBU.get());
				tabData.accept(StmwrModItems.INFINITITE_FORGING_HAMMER.get());
				tabData.accept(StmwrModItems.SHADED_RING.get());
				tabData.accept(StmwrModItems.COCAINE_GUN.get());
				tabData.accept(StmwrModItems.MEAT_KNIFE.get());
				tabData.accept(StmwrModItems.HOMESTONE_STAFF.get());
				tabData.accept(StmwrModItems.SACRIFICIAL_KNIFE.get());
				tabData.accept(StmwrModItems.INFINITITE_STAFF.get());
				...
				tabData.accept(StmwrModItems.WEASEL_ARMOR_HELMET.get());
				tabData.accept(StmwrModItems.WEASEL_ARMOR_CHESTPLATE.get());
				tabData.accept(StmwrModItems.WEASEL_ARMOR_LEGGINGS.get());
				tabData.accept(StmwrModItems.WEASEL_ARMOR_BOOTS.get());
				tabData.accept(StmwrModItems.GOBLIN_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.CRAZY_PERSON_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.FIRE_SLINGER_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.WEASEL_WORM_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.LAVAMBIE_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.DREAMLING_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.PAPER_BOY_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.THE_MEATY_ONE_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.EMPTINESS_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.SHADOW_MAN_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.HAPPY_PIG_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.HAPPY_CHICKEN_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.HAPPY_COW_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.PEACEFUL_CHILL_GUY_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.HUG_ENJOYER_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.GHOST_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.LOVE_MITE_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.MINION_OF_FIRE_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.FIRE_GUARDIAN_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.FORCE_OF_EMOTION_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.FORCE_OF_CHAOS_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.FORCE_OF_DREAMS_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.FORCE_OF_FIRE_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.SATAN_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.TRUMP_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.INFINITITE_GOLEM_SPAWN_EGG.get());
				tabData.accept(StmwrModItems.HEROBRINE_SPAWN_EGG.get());
			})
	...
	public static final RegistryObject<CreativeModeTab> STUFF_TO_MESS_WITH_REMODERNIZED = REGISTRY.register("stuff_to_mess_with_remodernized",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.stmwr.stuff_to_mess_with_remodernized")).icon(() -> new ItemStack(StmwrModItems.GODLIUM_ARMOR_CHESTPLATE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(StmwrModItems.TOTEM_OF_SPEED_III.get());
				...
				tabData.accept(StmwrModItems.TOTEM_OF_HEALTH_BOOST_III.get());
				...
				tabData.accept(StmwrModItems.TOTEM_OF_JUMP_BOOST_III.get());
				...
				tabData.accept(StmwrModItems.TOTEM_OF_HASTE_III.get());
				...
				tabData.accept(StmwrModItems.TOTEM_OF_STRENGTH_III.get());
				...
				tabData.accept(StmwrModItems.TOTEM_OF_HEALTH_REGENERATION_III.get());
