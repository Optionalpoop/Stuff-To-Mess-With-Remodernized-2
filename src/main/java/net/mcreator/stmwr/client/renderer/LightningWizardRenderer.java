...
public class LightningWizardRenderer extends HumanoidMobRenderer<LightningWizardEntity, HumanoidModel<LightningWizardEntity>> {
	...
	@Override
	protected void scale(LightningWizardEntity entity, PoseStack poseStack, float f) {
