...
public class ToolsAndArmorScreen extends AbstractContainerScreen<ToolsAndArmorMenu> {
	...
	public void init() {
		...
		button_godlium_knife = Button.builder(Component.translatable("gui.stmwr.tools_and_armor.button_godlium_knife"), e -> {
			if (true) {
				StmwrMod.PACKET_HANDLER.sendToServer(new ToolsAndArmorButtonMessage(5, x, y, z));
				ToolsAndArmorButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		...
		}).bounds(this.leftPos + 92, this.topPos + 47, 77, 20).build();
		...
		button_chicken_gun = Button.builder(Component.translatable("gui.stmwr.tools_and_armor.button_chicken_gun"), e -> {
			if (true) {
				StmwrMod.PACKET_HANDLER.sendToServer(new ToolsAndArmorButtonMessage(9, x, y, z));
				ToolsAndArmorButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
